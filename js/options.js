...
SQL.Options.prototype.build = function() {
	...
	this.dom.optionIncludeCommentsInSQL = OZ.$("optionIncludeCommentsInSQL");

	var ids = ["language","db","snap","pattern","hide","vector","showsize","showtype","optionsnapnotice","optionpatternnotice","optionsnotice","optionIncludeCommentsInSQL"];
...
SQL.Options.prototype.save = function() {
	...
	this.owner.setOption("includeCommentsInSQL",this.dom.optionIncludeCommentsInSQL.checked ? "1" : "");
}
...
SQL.Options.prototype.click = function() {
	...
	this.dom.optionIncludeCommentsInSQL.checked = this.owner.getOption("includeCommentsInSQL");
}
